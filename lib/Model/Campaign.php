...
class Campaign implements ArrayAccess
{
    ...
    {
        $this->container['id'] = isset($data['id']) ? $data['id'] : 55;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("ctr", "cpc", "cps", "cpe");
    ...
    public function setOptimizeType($optimize_type)
    {
        ...
        if (!in_array($optimize_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'optimize_type', must be one of 'ctr', 'cpc', 'cps', 'cpe'");
        }
