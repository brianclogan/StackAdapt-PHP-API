...
class LineItem implements ArrayAccess
{
    ...
    {
        $this->container['id'] = isset($data['id']) ? $data['id'] : 40;
        $this->container['name'] = isset($data['name']) ? $data['name'] : 'Default-IO';
    ...
    /**
     * Sets id
     * @param int $id The ID of the line_item.
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name The name of the line_item.
     * @return $this
     */
