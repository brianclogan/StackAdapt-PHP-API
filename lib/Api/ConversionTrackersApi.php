...
class ConversionTrackersApi
{
    ...
    /**
     * Operation createConversionTracker
     *
    ...
    {
        list($response) = $this->createConversionTrackerWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation createConversionTrackerWithHttpInfo
     *
     * Create new conversion tracker
     *
     * @param \Swagger\Client\Model\ConversionTracker $body  (optional)
    ...
    {
        // parse inputs
        $resourcePath = "/conversion_tracker";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation deleteConversionTrackers
     *
    ...
    {
        list($response) = $this->deleteConversionTrackersWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation deleteConversionTrackersWithHttpInfo
     *
     * Delete a conversion tracker
     *
     * @param int $id Id of conversion_tracker (required)
    ...
    public function deleteConversionTrackersWithHttpInfo($id)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteConversionTrackers');
        }
        // parse inputs
        $resourcePath = "/conversion_tracker/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation findConversionTracker
     *
    ...
    {
        list($response) = $this->findConversionTrackerWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation findConversionTrackerWithHttpInfo
     *
     * Find conversion tracker by id
     *
     * @param int $id Id of conversion_tracker (required)
    ...
    public function findConversionTrackerWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling findConversionTracker');
        }
        // parse inputs
        $resourcePath = "/conversion_tracker/{id}";
        $httpBody = '';
    ...
    /**
     * Operation findConversionTrackers
     *
    ...
    {
        list($response) = $this->findConversionTrackersWithHttpInfo();
        return $response;
    }

    /**
     * Operation findConversionTrackersWithHttpInfo
     *
     * Returns all conversion trackers
     *
     * @return Array of \Swagger\Client\Model\ConversionTracker[], HTTP status code, HTTP response headers (array of strings)
    ...
    {
        // parse inputs
        $resourcePath = "/conversion_trackers";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation updateConversionTracker
     *
    ...
    {
        list($response) = $this->updateConversionTrackerWithHttpInfo($id, $body);
        return $response;
    }

    /**
     * Operation updateConversionTrackerWithHttpInfo
     *
     * Update exisiting conversion tracker
     *
     * @param int $id Id of conversion_tracker (required)
    ...
    public function updateConversionTrackerWithHttpInfo($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling updateConversionTracker');
        }
        // parse inputs
        $resourcePath = "/conversion_tracker/{id}";
        $httpBody = '';
