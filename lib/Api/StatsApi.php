...
class StatsApi
{
    ...
    {
        list($response) = $this->getStats_0WithHttpInfo($resource, $type, $id, $start_date, $end_date, $timezone, $group_by_resource);
        return $response;
    }

    /**
     * Operation getStats_0WithHttpInfo
     *
     * Get stats
     *
     * @param string $resource The resource type to retrieve. Valid resources are: \&quot;campaign\&quot;, \&quot;conversion_tracker\&quot; \&quot;line_item\&quot;, \&quot;native_ad\&quot;, \&quot;advertiser\&quot;, or \&quot;buyer_account\&quot; (total account stats) (required)
    ...
    public function getStats_0WithHttpInfo($resource, $type, $id = null, $start_date = null, $end_date = null, $timezone = null, $group_by_resource = null)
    {
        // verify the required parameter 'resource' is set
        if ($resource === null) {
            throw new \InvalidArgumentException('Missing the required parameter $resource when calling getStats_0');
        }
        // verify the required parameter 'type' is set
        if ($type === null) {
            throw new \InvalidArgumentException('Missing the required parameter $type when calling getStats_0');
        }
        // parse inputs
        $resourcePath = "/stats";
        $httpBody = '';
